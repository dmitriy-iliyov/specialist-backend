...
//
//        redisConfirmationRepository.save(code, email);
//
//        assertEquals(Boolean.TRUE, redisTemplate.hasKey(CONFIRMATION_TOKEN_KEY_TEMPLATE.formatted(code)));
//    }
//
//    @Test
...
//        redisConfirmationRepository.save(code, email);
//
//        Optional<String> emailFromRedis = redisConfirmationRepository.findAndDeleteByToken(code);
//        assertTrue(emailFromRedis.isPresent());
//        assertEquals(email, emailFromRedis.get());
//
//        emailFromRedis = redisConfirmationRepository.findAndDeleteByToken(code);
...
//        redisConfirmationRepository.save(code, email);
//
//        Long ttl = redisTemplate.getExpire(CONFIRMATION_TOKEN_KEY_TEMPLATE.formatted(code), TimeUnit.SECONDS);
//        assertNotNull(ttl);
...
//        redisConfirmationRepository.save(code, email);
//
//        Optional<String> first = redisConfirmationRepository.findAndDeleteByToken(code);
//        Optional<String> second = redisConfirmationRepository.findAndDeleteByToken(code);
//
...
//        redisConfirmationRepository.save(code, email);
//
//        String expectedKey = "tkn:rsrc:conf:" + code;
