...
public class OAuth2Config {
    ...
    // because authorizationRequestBaseUri param necessary only for resolve(HttpServletRequest request) don't using
    @Bean
    public OAuth2AuthorizationRequestResolver oAuth2AuthorizationRequestResolver(ClientRegistrationRepository repository) {
        return new DefaultOAuth2AuthorizationRequestResolver(repository, "/stubbingUrl");
    }
}
