...
public class EmailUniquenessValidator implements ConstraintValidator<UniqueEmail, AccountCreateDto> {

    private final SystemAccountService accountService;

    @Override
    public boolean isValid(AccountCreateDto dto, ConstraintValidatorContext context) {
