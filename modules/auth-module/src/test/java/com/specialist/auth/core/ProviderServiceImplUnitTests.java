...
import com.specialist.auth.domain.auth_provider.ProviderServiceImpl;
...
class ProviderServiceImplUnitTests {
    ...
    void findAll_withInMemoryRepository_shouldReturnProvidersMap() {
        ...
        assertEquals("/api/auth/oauth2/authorize/google", result.get("google"));
        assertEquals("/api/auth/oauth2/authorize/github", result.get("github"));
    }
}
