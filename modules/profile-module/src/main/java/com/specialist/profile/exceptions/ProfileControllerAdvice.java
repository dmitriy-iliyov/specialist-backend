...
@RestControllerAdvice(basePackages = "com.specialist.profile")
public class ProfileControllerAdvice extends BaseControllerAdvice {

    public ProfileControllerAdvice(ExceptionMapper exceptionMapper, MessageSource messageSource) {
